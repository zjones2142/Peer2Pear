    ...
    , ui(new Ui::MainWindow)
{
    ...
    m_mainStack->addWidget(ui->contentWidget);//index 0 – normal chat view

    //Build and add settings panel
    m_settingsPanel = new SettingsPanel(ui->rootWidget);   //replaces buildSettingsPanel() to accomadate the new files
    m_mainStack->addWidget(m_settingsPanel);               //index 1 – settings view(where chat is at index 0)
    ...
    //Settings StackedWidget Connects
